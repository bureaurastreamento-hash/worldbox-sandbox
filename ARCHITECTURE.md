...
Status: fatias 1-11 implementadas (ver `DESIGN.md`, seção 5), mais especialização de vila, diplomacia dinâmica entre clãs e evolução da civilização em andamento (minério — `DESIGN.md` §6-8) além do roteiro original. Ver `STATUS.md` pra próximos passos concretos.
